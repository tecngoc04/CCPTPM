...
<body>
    ...
    <section id="information">
        <div class="container text-center">
            <p class="p-5" style="width: 67%; margin: 0 auto;font-family:Montserrat-Regular;">Phòng Suite có diện tích phòng 65m², nằm trên 2 tầng cao nhất của khách sạn. Tiện nghi hiện đại, phòng khách sang trọng, phòng tắm rộng rãi và phòng ngủ riêng mang đến trải nghiệm thư giãn đẳng cấp.</p>
        </div>
        <section id="slider">
            <div class="container">
