        ...
        <div class="col-7 d-flex justify-content-end" style="align-items: center;">
          <ul class="nav nav-pills">
            <li class="nav-item p-2">
              <a class="nav-link active  rounded-0" aria-current="page" href="#" style="background-color:#937438;">Active</a>
            </li>
            <li class="nav-item p-2">
              <a class="nav-link active rounded-0" href="#" style="background-color:black;">Link</a>
            </li>
            <li class="nav-item p-2">
              <a class="nav-link active rounded-0" href="#" style="background-color:black;">Link</a>
            </li>
